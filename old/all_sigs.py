...
def main():
    ...
    # fwhm_sm = 2.0
    fwhm_sm_string = '{:3.1f}'.format(fwhm_sm)
    ...
    for i, obj in enumerate(objects):
        ...
        ax1.axvline(x=dm, lw=0.5, color='blue', linestyle='-')
        ax1.axvline(x=dmc, lw=0.5, color='limegreen', linestyle='-')
    ...
    plt.savefig('detections_significance_{:3.1f}.pdf'.format(fwhm_sm))
